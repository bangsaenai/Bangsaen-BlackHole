...
* To protect our proprietary Deep Tech mathematics, the core engine (`kks_nullspace`) is provided as a pre-compiled bytecode binary (`.pyc`).
* The evaluation mode is strictly hardcoded to process **1 file at a time**. Batch processing is disabled.

## 🛠️ How to Experience the Annihilation (Cross-Platform)
